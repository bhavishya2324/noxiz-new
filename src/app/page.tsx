              ...
              <div className="flex items-center flex-col">
                ...
                >
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-neutral-500 to-neutral-600  md:text-center font-sans group-hover:bg-gradient-to-r group-hover:from-black goup-hover:to-black">
                    <Link href="https://calendly.com/noxiz/30-minute-meeting">Schedule Consultation</Link>
                  </span>
                </Button>
                <h2 className="text-4xl md:text-8xl  bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-bold">
                Step into the Future with Noxiz
                </h2>
              </div>
            }
          />
